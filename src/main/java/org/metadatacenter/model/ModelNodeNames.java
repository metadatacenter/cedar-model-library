...
public class ModelNodeNames
{
  ...
  public static final String FIELD_INPUT_TYPE_EXT_NIH_GRANT_ID = "ext-nih-grant-id";
  ...
  public static final Set<String> INPUT_TYPES = Stream.of(FIELD_INPUT_TYPE_TEXTFIELD, FIELD_INPUT_TYPE_TEXTAREA,
    ...
    FIELD_INPUT_TYPE_EXT_NIH_GRANT_ID, FIELD_INPUT_TYPE_EXT_PUBMED, FIELD_INPUT_TYPE_EXT_DOI, FIELD_INPUT_TYPE_YOUTUBE,
  ...
  public static final String VALUE_CONSTRAINTS_TYPE_VALUE = "Value";
  ...
  public static final Set<String> VALUE_CONSTRAINTS_KEYWORDS = Stream.of(VALUE_CONSTRAINTS_ONTOLOGIES,
    ...
    VALUE_CONSTRAINTS_TYPE_VALUE, VALUE_CONSTRAINTS_NAME, VALUE_CONSTRAINTS_ACRONYM, VALUE_CONSTRAINTS_EXCLUSIONS,
